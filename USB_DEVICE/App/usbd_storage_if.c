...
// 引用外部TF卡参数（在main.c中定义）
extern uint32_t g_tf_block_num;
extern uint16_t g_tf_block_size;
extern SD_HandleTypeDef hsd;
extern HAL_SD_CardInfoTypeDef card_info;  // 需要在main.c中定义这个变量
